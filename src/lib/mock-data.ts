...
export const MOCK_TICKETS: Ticket[] = [
  ...
  // Payments
  { id: '4', ticket_id: 'TKT-004', sender_email: 'urgent@gmail.com', subject: 'Payment gateway is down', summary: 'Multiple students reporting payment gateway returning 500 errors. Affecting all courses.', department: 'Finance', priority: 'Critical', status: 'Open', issue_type: 'Gateway Down', date_time: hoursAgo(0.5), assigned_to: 'bob@edtech.com', notes: [{ author: 'Bob Kumar', text: 'Investigating gateway logs now', created_at: hoursAgo(0.3) }], created_at: hoursAgo(0.5) },
  { id: '5', ticket_id: 'TKT-005', sender_email: 'refund@gmail.com', subject: 'Payment deducted but no access', summary: 'Rs 15,000 deducted from account but course still shows as locked.', department: 'Finance', priority: 'High', status: 'In Progress', issue_type: 'Payment No Access', date_time: hoursAgo(4), assigned_to: 'bob@edtech.com', notes: [], created_at: hoursAgo(4) },
  { id: '6', ticket_id: 'TKT-006', sender_email: 'invoice@gmail.com', subject: 'Need invoice for tax filing', summary: 'Requesting invoice for previous semester payment for tax purposes.', department: 'Finance', priority: 'Medium', status: 'Open', issue_type: 'Invoice Request', date_time: hoursAgo(8), assigned_to: 'bob@edtech.com', notes: [], created_at: hoursAgo(8) },
  { id: '7', ticket_id: 'TKT-007', sender_email: 'billing@gmail.com', subject: 'Billing cycle question', summary: 'When does the next billing cycle start?', department: 'Finance', priority: 'Low', status: 'Open', issue_type: 'Billing Question', date_time: hoursAgo(24), assigned_to: 'bob@edtech.com', notes: [], created_at: hoursAgo(24) },
  // Tech Support
